export const DOCUMENT_TYPES = [
  ...
  // Real property (specifics before generic deed)
  'lady_bird_deed',
  'life_estate_deed',
  'transfer_deed',
  'trustees_deed',
  ...
  'funeral_contract',
  'medical_record',
  'digital_asset_record',
  'safe_deposit_inventory',
  'unknown',
]
...
export const DOCUMENT_TYPE_LABELS = {
  ...
  healthcare_surrogate:       'Healthcare Surrogate Designation',
